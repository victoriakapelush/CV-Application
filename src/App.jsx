...
export default function App() {
  ...
  const addSkills = () => {
    setData({
      ...data,
      skills: [...data.skills, { id: uuidv4(), name: "Skills", text: "" }],
    });
  };
  ...
  return (
    <div className="container">
      <div className="inputs flex-column">
        ...
        <div>
          <PersonalData data={data} handleData={handleData} />
        </div>
        <div>
          <Experience
            data={data}
      ...
      <div className="app" ref={contentRef} style={{ paddingTop: "2rem" }}>
        ...
        <h3 className="occupation">
          {data.info[2].text || "Software Developer"}
        </h3>
                ...
                <>
                  <div className="exp-row flex-row">
                    <h3 className="position">
                      {experience.position || "Project Manager Intern"}
                    </h3>
                    <h4 className="company">
                      {experience.company || "The United Nations"}
                    </h4>
                    <p className="years">
                      {experience.years || "01/2019 - 06/2019"}
                    </p>
                  </div>
                  <p className="description">
                    {experience.description ||
                      "Developed comprehensive project plans outlining timelines, milestones, and deliverables. Identified and allocated resources efficiently to ensure project success. Conducted risk assessments and implemented mitigation strategies."}
                  </p>
                </>
              ))}
            </div>
              ...
              {data.education.map((education) => (
                <div className="education-container flex-row">
                  <h3 className="college">
                    {education.college || "Brooklyn College, NY"}
                  </h3>
                  <h4 className="degree">
          ...
          <div className="education-section flex-column">
            ...
            <div className="skill-container flex-row">
              {data.skills.map((skill) => (
                <h3 className="skill">
                  {skill.text || "JavaScript, React, MongoDB, Python"}
                </h3>
              ))}
            </div>
          </div>
